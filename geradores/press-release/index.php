...
{title : 'Red text', inline : 'span', styles : {color : '#ff0000'}}
	...
	<body>
	<div id="wrapper">
		<h1>Gerador de Código HTML para Press Release Consegi</h1>
		<p>Preencha os dados abaixo para criar o email</p>
		<form enctype="multipart/form-data" action="press-release.php" method="post">

		<fieldset>
			<label for="titulo">Título</label>
			<input type="text" name="titulo" size="50" />
			<br />
			<label for="subtitulo">Sutiã</label>
			<input type="text" name="sutia" size="50" />
			<br />
			<label for="content">Corpo da Mensagem</label>
			<textarea name="content" cols="50" rows="15"></textarea>
			<br />
			<input type="submit" value="Gerar Release" />
