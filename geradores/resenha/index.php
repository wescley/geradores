...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR">
	<head>
		...
		<title>Gerador Formulário | Resenha Eletrônica</title>
  ...
  if(document.index.dez.checked==false)
  {
	...
	<div id="wrapper">
		<div id="content">
			...
			<p>Selecione os campos abaixo para gerar o formulário de criação do Resenha Eletrônica.</p>
			<form action="resenhador.php" method="post" name="index">
			<fieldset class="noticias">
				...
				<ol>
					...
					<li>
						<input type="checkbox" name="dois" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="tres" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="quatro" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="cinco" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="seis" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="sete" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="oito" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="nove" value="1" onClick="apply()" />
					...
					<li>
						<input type="checkbox" name="dez" value="1" onClick="apply()" />
